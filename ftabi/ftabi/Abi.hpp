...
struct FunctionCall : public td::CntObject {
  ...
  explicit FunctionCall(HeaderValues&& header, InputValues&& inputs, bool internal, td::optional<td::Ed25519::PrivateKey>&& private_key);
...
class Function : public td::CntObject {
 public:
  ...
  auto encode_input(const HeaderValues& header, const InputValues& inputs, bool internal, const td::optional<td::Ed25519::PrivateKey>& private_key) const
